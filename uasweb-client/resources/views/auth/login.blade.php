...
<div class="py-5 text-center">
    <div class="container">
        <div class="row">
            <div class="mx-auto col-md-4 col-10 bg-white p-5 submit offset-md-2">
                <h1 class="mb-4 text-primary">Log in</h1>
                <form method="POST" action="{{ route('login') }}">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <input type="email" class="form-control email" placeholder="Enter email" id="email" name="email">
                        @error('email')
                ...
                <a class="btn btn-link" href="{{ route('register') }}">I don't have an account</a>
            </div>
        </div>
    </div>
</div>
